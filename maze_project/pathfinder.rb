require 'byebug'
# maze = File.readlines('./maze1.txt').map(&:chomp)

# This block of code prints out our maze in terminal as it appears in the original file
# maze.each do |row|
#     puts row
# end

# p maze.length   # height
# p maze.first.length # width
# p maze[1][14]   # position [row][column] 
# if we define a position as our maze grid double indexed, we can think of movement only possible by +/- one of the indices
